...
pub struct Tiles {
    #[get_copy = "pub"]
    size: usize,
    owners: TileList<Owner>,
    neighbors: TileList<Neighbors>,
    doublets: TileList<[Doublet; 4]>,
    triplets_l: TileList<[TripletL; 8]>,
    triplets_i: TileList<[TripletI; 4]>,
    blobs: TileList<Blob>,
    nonces: TileList<usize>,
}
